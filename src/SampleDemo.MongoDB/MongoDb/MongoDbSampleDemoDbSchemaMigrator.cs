...
public class MongoDbSampleDemoDbSchemaMigrator : ISampleDemoDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSampleDemoDbSchemaMigrator(IServiceProvider serviceProvider)
    {
